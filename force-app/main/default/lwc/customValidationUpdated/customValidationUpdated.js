...
export default class CustomValidationUpdated extends LightningElement {
    ...
    isInputValid()
    {
        ...
        let company = this.template.querySelector('[data-id="company"]');
        let phone = this.template.querySelector('[data-id="phone"]');
        let pincode = this.template.querySelector('[data-id="pincode"]');
        if(firstname.value=='' || password.value=='' || firstname.value=='' || email.value=='' || country.value==undefined || lastname.value=='' || company.value=='' || phone.value=='' || pincode.value=='' || enddate.value=='' || startdate.value=='')
        {
            isValid=false;
        ...
        {
            isValid=false;
            this.handleError('Start date must be smaller than End date');
            return isValid;
        }
        if(phone.value[0]!='+' || phone.value[1]!='9' || phone.value[2]!='1')
        {
            isValid=false;
            this.handleError('Phone number must be start with +91');
            return isValid;
        }
        isValid=true;
    ...
    handleChange(event)
    {
        //console.log('##ChangeFieldName##->'+event.target.name);
